  ...
  return (
    ...
    >
      <FadeIn
        ...
        delay={0}
        y={-20}
        className="relative z-20 flex w-full items-center justify-between px-6 pt-6 text-sm font-medium uppercase tracking-wider text-[#D7E2EA] md:px-10 md:pt-8 md:text-lg lg:text-[1.4rem]"
      >
        {NAV_LINKS.map((link) => (
          <a
            key={link.name}

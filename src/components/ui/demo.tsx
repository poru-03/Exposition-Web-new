...
export const PROCESS_PHASES: PhaseItem[] = [
  ...
  },
  {
    ...
    description:
      "A live digital platform aggregating university-level tech events across Sri Lanka including hackathons, robotics competitions, and innovation challenges.",
